...
// =============================================================================
//
// Provides XLOG-compatible macros backed by spdlog for high-performance logging.
//
// Features:
...
// - Async logging option for minimal latency
// - Format string support via {fmt}
//
// Usage:
//   XLOG(INFO) << "Server started on port " << port;
//   XLOG(ERR) << "Connection failed: " << error;
//   XLOG(DBG1) << "Debug info: " << details;
//
//   XLOGF(INFO, "Server started on port {}", port);
//   XLOGF(ERR, "Connection failed: {}", error);
//
// =============================================================================
