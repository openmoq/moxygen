 ...
 *   MyClient client("moq-relay.example.com", &evb, &exec);
...
class MoQPicoQuicEventBaseClient {
 public:
   ...
   */
  MoQPicoQuicEventBaseClient(std::string endpoint,
                              folly::EventBase* evb,
  ...
  MoQPicoQuicEventBaseClient& operator=(const MoQPicoQuicEventBaseClient&) =
      delete;
  MoQPicoQuicEventBaseClient& operator=(MoQPicoQuicEventBaseClient&&) = delete;
 ...
 private:
  ...
  // Called from picoCallback via friend on connection close (pre- or post-session).
  ...
  MoQFollyExecutorImpl* executor_; // non-owning
